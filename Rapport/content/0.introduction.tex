...
Par conséquent, il est parfaitement logique de se demander comment évaluer la qualité d'une projection et comment choisir la méthode de projection en fonction d'un jeu de données en particulier.
...
Enfin nous parlerons en détails du programme permettant d'évaluer ces diffénts types de projections que nous avons mis en place.
