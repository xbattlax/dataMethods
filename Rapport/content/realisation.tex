...
\subsection{L'index Rogers Tanimoto}
...
\subsection{Les index Sokal Sneath}
...
Nous pouvons constater que dans une grande majorité des cas c'est l'ACP qui a les meilleurs résultats et que c'est systématiquement le premier jeu de données
...
Tout d'abord, il aurait été intéressant de tester la méthode classNerv, qui au vu des résultats présentés dans la première partie de ce rapport
